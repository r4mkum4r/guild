 ...
 * Build: http://modernizr.com/download/#-fontface-backgroundsize-borderimage-borderradius-boxshadow-flexbox-flexboxlegacy-hsla-multiplebgs-opacity-rgba-textshadow-cssanimations-csscolumns-generatedcontent-cssgradients-cssreflections-csstransforms-csstransforms3d-csstransitions-canvas-hashchange-history-input-inputtypes-localstorage-sessionstorage-geolocation-inlinesvg-svg-touch-webgl-shiv-mq-cssclasses-addtest-teststyles-testprop-testallprops-hasevent-prefixes-domprefixes-css_mediaqueries-css_pointerevents-elem_datalist-elem_details-forms_placeholder-forms_validation-json-url_data_uri
 *
 * Also includes a custom Window 8 touch test added to the end
 */
;
...
})(document, window.Modernizr);// native JSON support.
...
// END OF BUILD FROM MODERNIZR.COM //
...
Modernizr.selectorSupported = function(selector){
...
Modernizr.addTest('checkedselector',function(){
  return Modernizr.selectorSupported(':checked');
});
...
conditionizr.add('edge', /(edge\/[0-9]{2}\.)/i.test(navigator.userAgent));
...
conditionizr.add('lt-ie11', conditionizr.ie10 || conditionizr.ie9);
conditionizr.add('lt-ie10', conditionizr.ie9);
 ...
 */
conditionizr.add('no-retina', !(window.devicePixelRatio >= 1.5));
...
/* add medium-screen to html when match media query for screen width 541 - 768px */
conditionizr.add('medium-screen', window && 'matchMedia' in window && window.matchMedia("screen and (min-width: 541px) and (max-width: 768px)").matches);
/* add small-screen to html when match media query for screen width 0 - 540px */
conditionizr.add('small-screen', window && 'matchMedia' in window && window.matchMedia("screen and (min-width: 0px) and (max-width: 540px").matches);
conditionizr.config({
    tests: {
        chrome: ['class'],
        safari: ['class'],
